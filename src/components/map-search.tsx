		...
		>
			...
			<div className="relative">
				...
				<input
					...
					className="w-full pl-10 pr-10 py-2.5 border-2 border-orange-200 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-400 transition-all duration-200 text-sm"
				/>
				{query && (
					<button
						onClick={handleClear}
